...
VALUES (1, 'HOUSE', 23, 'CHUI', 'Yssyk-Ata', 'Grajdanskaya 119', 'for sanatory', 'BOOKED', 'house', 3, NOW(), NULL, 1,
       ...
       (15, 'APARTMENT', 12, 'BISHKEK', 'ALAMIDIN-1', 'Усенбаева 106', 'for long time', 'BOOKED', 'apartment', 2, NOW(),
        NULL, 2, 'REJECT',42.8856298,74.61489209999999,false),
       (16, 'APARTMENT', 89, 'BISHKEK', 'Chui Prospect', 'Малдыбаева 6', 'Central location', 'NOT_BOOKED', 'apartment',
        5, NOW(), NULL, 2, 'MODERATION',42.8470298,74.5972297,false);
